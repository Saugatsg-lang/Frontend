      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 32 }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 28 }}>
            {[["📍", "Our Location", "123 Fashion Ave, New York, NY 10001"], ["📧", "Email Us", "hello@smartshop.com"], ["📞", "Call Us", "+1 (800) SMART-SHOP"], ["🕒", "Business Hours", "Mon–Fri: 9AM–8PM EST"]].map(([icon, label, val]) => (
          ...
          <div style={{ borderRadius: 16, overflow: "hidden", height: 200, background: "linear-gradient(135deg, #f0f0ff, #e0e8ff)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", border: "1.5px solid var(--border)" }}>
            ...
            <div style={{ fontWeight: 700, color: "#6366f1", marginTop: 8 }}>New York, NY</div>
